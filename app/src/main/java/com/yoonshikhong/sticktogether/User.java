...
public class User {
	...
	void updateMap() {
		...
		marker = map.addMarker(markerOptions.position(new LatLng(latitude, longitude)).title(name).icon(BitmapDescriptorFactory.fromResource(R.drawable.rsz_person_pin_resized_32)));
	}
